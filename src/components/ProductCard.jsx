    ...
    return (
        <div className="flex justify-between items-center pl-4 bg-[#292929] text-white rounded-2xl h-[88px]">
            <div className="flex flex-col justify-center items-start">
                <p className="font-bold text-[17px] tracking-wide leading-[24px] -mt-0.5">{data.name}</p>
            ...
            <img src={`/images/dishes/${data.img}.png`} alt=""  className="mr-1 p-0.5 h-[90%] aspect-square bg-amber-600 rounded-xl"/>
        </div>
    )
}