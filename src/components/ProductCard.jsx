export default function ProductCard({data, setOpen}) {
    ...
    return (
        <div className="flex justify-between items-center pl-4 bg-[#404040] text-white rounded-2xl h-[88px]">
            <div className="flex flex-col justify-center items-start">
                <p className="permanent-marker-font font-bold text-lg tracking-wide leading-[24px] -mt-0.5">{data.name}</p>
