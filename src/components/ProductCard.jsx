...
export default function ProductCard({ data, setOpen }) {
    ...
    return (
        <div className="group relative flex justify-between items-center pl-4 pr-2 bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] border border-white/5 text-white rounded-2xl sm:h-[94px] h-[95px] w-full shadow-lg hover:shadow-amber-500/10 hover:scale-[1.02] transition-all duration-300 cursor-pointer overflow-hidden">
            ...
            <div className="flex flex-col justify-center items-start z-10 w-full max-w-[calc(100%-85px)] sm:max-w-[calc(100%-90px)]">
                <p className="font-bold sm:text-lg text-base leading-tight tracking-wide kalam-font line-clamp-1 text-gray-100 group-hover:text-amber-400 transition-colors duration-300">{data.name}</p>
            ...
            <div className="relative h-[75px] w-[75px] sm:h-[80px] sm:w-[80px] flex-shrink-0">
                <div className="absolute inset-0 bg-amber-500/20 rounded-full blur-lg scale-100 transition-transform duration-500"></div>
                <img
