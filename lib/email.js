  ...
  try {
    ...
    const itemsHtml = items.map(item => `
      <tr style="border-bottom: 1px solid #2a2a35;">
        <td style="padding: 12px 8px; color: #ffffff; font-weight: bold; font-size: 14px;">${item.name}</td>
        <td style="padding: 12px 8px; color: #f59e0b; text-align: center; font-weight: bold; font-size: 14px;">x${item.quantity}</td>
